        ...
        <div class="order-form__wrapper">
            ...
            <div class="order-form__body">
                <label class="order-form__label">
                    ...
                    <small v-if="errors?.name" id="name-error" class="order-form__error" role="alert">{{ errors?.name[0] || '&nbsp;' }}</small>
                </label>
                <label class="order-form__label">
                    ...
                    <small v-if="errors?.phone" id="phone-error" class="order-form__error" role="alert">{{ errors?.phone[0] || '&nbsp;' }}</small>
                </label>
                <label class="order-form__label">
                    ...
                    <small v-if="errors?.email" id="email-error" class="order-form__error" role="alert">{{ errors?.email[0] || '&nbsp;' }}</small>
                </label>
                <label class="order-form__label">
                    <span class="visually-hidden">Ваш комментарий</span>
                    <textarea
                        ...
                        @focus="errors = null"
                    />
                    <small v-if="errors?.message" id="message-error" class="order-form__error" role="alert">{{ errors?.message[0] || '&nbsp;' }}</small>
                </label>
            </div>
            <div class="order-form__footer">
                <label class="order-form__file file">
                    ...
                    <small v-if="errors?.attachment" id="attachment-error" class="order-form__error" role="alert">
                        {{ errors?.attachment[0] || '&nbsp;' }}
                    </small>
                </label>
                <UiButton
